...
public class CustomerController {
	...
	public ResponseEntity<?> saveCustomer(@Valid @RequestBody Customer requestDTO, BindingResult bindingResult)
		...
		if (bindingResult.hasErrors()) {
			...
			return ResponseEntity.ok(
					invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Customer added successfully", null));
		}
	}

	@RequestMapping(value = "${api.route.customer.update}/{custId}", method = RequestMethod.POST)
	public ResponseEntity<?> updateCustomer(@Valid @RequestBody Customer requestDTO, @PathVariable int custId,
		...
		if (bindingResult.hasErrors()) {
			...
			log.log(Level.FINEST, "Inside save customer request controller");
			customerService.update(requestDTO, custId);

			return ResponseEntity.ok(
					invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Customer updated successfully", null));
		}
	}

	@RequestMapping(value = "${api.route.invoice.add}/{custId}", method = RequestMethod.POST)
	public ResponseEntity<?> saveInvoice(@PathVariable int custId, @Valid @RequestBody Invoice requestDTO,
			BindingResult bindingResult) throws InvoiceException {
		if (bindingResult.hasErrors()) {
			return ResponseEntity.ok(invoiceUtility.createResponseEntityDTO(HttpStatusCodes.VALIDATION_ERROR,
					bindingResult.getAllErrors().get(0).getDefaultMessage(), null));
			...
			return ResponseEntity
					.ok(invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Invoice added successfully", null));
		}
	}
	...
	public ResponseEntity<?> saveProject(@PathVariable int invoiceId,
			@Valid @RequestBody InvoiceProjectDetails requestDTO, BindingResult bindingResult) throws InvoiceException {
		if (bindingResult.hasErrors()) {
			return ResponseEntity.ok(invoiceUtility.createResponseEntityDTO(HttpStatusCodes.VALIDATION_ERROR,
					bindingResult.getAllErrors().get(0).getDefaultMessage(), null));
		} else {
			...
			return ResponseEntity.ok(
					invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Projects added successfully", null));
		}
	}
	...
	public ResponseEntity<?> getProjectDetails(@PathVariable int invoiceId) throws InvoiceException {
	...
	public ResponseEntity<?> getInvoice(@PathVariable int invoiceId) throws InvoiceException {

		log.log(Level.FINEST, "Inside general request controller");
		Invoice invoice = customerService.getInvoice(invoiceId);

		return ResponseEntity.ok(
				invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Invoice fetched successfully", invoice));
	}
	...
	public ResponseEntity<?> getInvoiceDetails(@PathVariable int custId) {
		...
		return ResponseEntity.ok(
				invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Invoice fetched successfully", invoices));
	}
	...
	public ResponseEntity<?> export(@PathVariable int custId, @PathVariable int invoiceId,
		...
		return ResponseEntity
				.ok(invoiceUtility.createResponseEntityDTO(HttpStatusCodes.OK, "Invoice fetched successfully", null));
	}
